...
public class AdminAction extends HttpServlet {
	...
	private List<User>  usersList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// get students from db util
		List<User> users = dbRetrieve.getUsers();
		return users;
	}
	...
	private void login(HttpServletRequest request, HttpServletResponse response ) throws Exception {
		...
		List<User> users=usersList(request,response);
		 for(User user:users)  
		 { 
			...
			classesList(request, response);
			//RequestDispatcher dispatcher = request.getRequestDispatcher("/portalAdmin.jsp");
			//dispatcher.forward(request, response);
